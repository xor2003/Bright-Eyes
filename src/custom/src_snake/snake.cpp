...
cs=0x1b2;eip=0x000121; 	R(RETN);	// 288 retn ;~ 01B2:0121
...
cs=0x1b2;eip=0x000129; 	R(RETN);	// 300 retn ;~ 01B2:0129
...
cs=0x1b2;eip=0x00013d; 	R(RETN);	// 318 retn ;~ 01B2:013D
cs=0x1b2;eip=0x00013e; loc_1023e:	// 4391 
cs=0x1b2;eip=0x00013e; 	T(MOV(ah, 2));	// 322 mov     ah, 2 ;~ 01B2:013E
cs=0x1b2;eip=0x000140; 	R(RETN);	// 323 retn ;~ 01B2:0140
...
cs=0x1b2;eip=0x000149; 	R(RETN);	// 338 retn ;~ 01B2:0149
...
cs=0x1b2;eip=0x00018b; 	R(RETN);	// 373 retn ;~ 01B2:018B
...
cs=0x1b2;eip=0x000194; 	R(RETN);	// 388 retn ;~ 01B2:0194
...
cs=0x1b2;eip=0x00019b; 	R(RETN);	// 396 retn ;~ 01B2:019B
...
cs=0x1b2;eip=0x0001b5; 	R(RETN);	// 412 retn ;~ 01B2:01B5
...
cs=0x1b2;eip=0x0001c7; 	R(RETN);	// 421 retn ;~ 01B2:01C7
...
cs=0x1b2;eip=0x0001d9; 	R(RETN);	// 430 retn ;~ 01B2:01D9
...
cs=0x1b2;eip=0x0001f0; 	R(RETN);	// 444 retn ;~ 01B2:01F0
cs=0x1b2;eip=0x0001f1; loc_102f1:	// 4405 
cs=0x1b2;eip=0x0001f1; 	T(INC(quit));	// 448 inc     quit ;~ 01B2:01F1
cs=0x1b2;eip=0x0001f5; 	R(RETN);	// 449 retn ;~ 01B2:01F5
...
cs=0x1b2;eip=0x00029e; 	R(RETN);	// 558 retn ;~ 01B2:029E
...
cs=0x1b2;eip=0x0002cd; 	R(RETN);	// 593 retn ;~ 01B2:02CD
...
cs=0x1b2;eip=0x0002f8; 	R(RETN);	// 623 retn ;~ 01B2:02F8
...
cs=0x1b2;eip=0x000323; 	R(RETN);	// 653 retn ;~ 01B2:0323
...
cs=0x1b2;eip=0x000359; 	R(RETN);	// 695 retn ;~ 01B2:0359
...
cs=0x1b2;eip=0x0000a2; 	R(RETN);	// 221 retn ;~ 01B2:00A2
